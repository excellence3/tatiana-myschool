...
public class BootstrapData implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        Student student2 = new Student ("Peppa","Pig",10,class2);
        Student student3 = new Student ("Duffy","Duck",10,class3);
        Student student4 = new Student ("Spedy","Gonzalez",10,class1);
        Student student5 = new Student ("Lola","Bunny",10,class2);
        Student student6 = new Student ("Pippo","Pluto",10,class3);
